...
/** 
 * DAO for table "BONDS_DATA_BEAN".
*/
public class BondsDataBeanDao extends AbstractDao<BondsDataBean, Long> {

    public static final String TABLENAME = "BONDS_DATA_BEAN";

    /**
     * Properties of entity BondsDataBean.<br/>
    ...
    public static class Properties {
        ...
        public final static Property BondsNum = new Property(5, int.class, "bondsNum", false, "BONDS_NUM");
    }


    public BondsDataBeanDao(DaoConfig config) {
        super(config);
    }
    
    public BondsDataBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"BONDS_DATA_BEAN\" (" + //
                ...
                "\"BONDS_NUM\" INTEGER NOT NULL );"); // 5: bondsNum
    }

    /** Drops the underlying database table. */
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"BONDS_DATA_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, BondsDataBean entity) {
        stmt.clearBindings();
        ...
        stmt.bindLong(6, entity.getBondsNum());
    }

    @Override
    protected final void bindValues(SQLiteStatement stmt, BondsDataBean entity) {
        stmt.clearBindings();
    ...
    @Override
    public BondsDataBean readEntity(Cursor cursor, int offset) {
        BondsDataBean entity = new BondsDataBean( //
            ...
            cursor.getInt(offset + 5) // bondsNum
        );
        return entity;
    }
     
    @Override
    public void readEntity(Cursor cursor, BondsDataBean entity, int offset) {
        ...
        entity.setBondsNum(cursor.getInt(offset + 5));
     }
    
    @Override
    protected final Long updateKeyAfterInsert(BondsDataBean entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(BondsDataBean entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(BondsDataBean entity) {
